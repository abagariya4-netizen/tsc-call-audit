...
- For closing, if no evidence of closing is found (e.g. call cut), consider that NA (so scoring is not affected). If closing occurs, score up to 15 points based on quality.
